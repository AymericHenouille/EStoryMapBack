...
-- Insert workspaces
insert into workspaces (label, color, emoticon, owner_id) values ('Workspace 1', '#2ecc71', U&'\d83e\dd13', '0');
insert into workspaces (label, color, emoticon, owner_id) values ('Workspace 2', '#e74c3c', U&'\d83e\dd14', '0');
insert into workspaces (label, color, emoticon, owner_id) values ('Workspace 1', '#8e44ad', U&'\d83e\dd15', '1');
insert into workspaces (label, color, emoticon, owner_id) values ('Workspace 2', '#f39c12', U&'\d83e\dd16', '1');
